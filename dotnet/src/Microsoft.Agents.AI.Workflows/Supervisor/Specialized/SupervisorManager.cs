...
internal class SupervisorManager(AIAgent managerAgent)
{
    ...
    public async ValueTask<TaskLedger> UpdatePlanAsync(SupervisorTaskContext taskContext, IWorkflowContext context, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask UpdateProgressLedgerAsync(SupervisorTaskContext taskContext, IWorkflowContext context, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask<ChatMessage> PrepareFinalAnswerAsync(SupervisorTaskContext taskContext, IWorkflowContext context, CancellationToken cancellationToken)
    {
        ...
        {
            AuthorName = finalAnswer.AuthorName ?? nameof(SupervisorManager),
