...
internal record SupervisorTaskState(List<ChatMessage> TaskDefinition, List<ChatMessage> ChatHistory, TaskLedger? TaskLedger, JsonElement? ProgressLedgerState, TaskCounters Counters, bool Terminated, bool? EmitUpdateEvents)
{
}

internal class SupervisorTaskContext(List<ChatMessage> taskDefinition, List<AIAgent> team, TaskLimits limits, bool? emitUpdateEvents, IEnumerable<ProgressLedgerSlot> additionalProgressQuestions)
{
    internal SupervisorTaskContext(SupervisorTaskState state, List<AIAgent> team, TaskLimits limits, IEnumerable<ProgressLedgerSlot> additionalProgressQuestions)
    ...
    public SupervisorProgressLedger ProgressLedger { get; } = new(GetTeamNames(team), additionalProgressQuestions);
    ...
    public SupervisorTaskState ExportState()
    {
