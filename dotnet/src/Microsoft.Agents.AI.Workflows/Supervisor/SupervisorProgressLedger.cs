...
/// </summary>
public class SupervisorProgressLedger
{
    internal static readonly BooleanProgressLedgerSlot IsRequestSatisfiedSlot = new(
        "is_request_satisfied",
        "Is the request fully satisfied? (True if complete, or False if the original request has yet to be SUCCESSFULLY and FULLY addressed)");

    internal static readonly BooleanProgressLedgerSlot IsInLoopSlot = new(
        "is_in_loop",
    ...
    internal static readonly BooleanProgressLedgerSlot IsProgressBeingMadeSlot = new(
    ...
    internal static readonly StringProgressLedgerSlot InstructionOrQuestionSlot = new(
    ...
    internal SupervisorProgressLedger(string teamNames, IEnumerable<ProgressLedgerSlot> additionalQuestions, JsonElement? state = null)
    {
